...
class ParceiroProcedimento extends REST_Controller {
	...
	public function index_get( $id_parceiro=null, $id_parceiro_procedimento=null )
	{
		...
		$options = array(
			'fields'	=> 'id_parceiro_procedimento, observacao, horario_atendimento, comissao, valor_parceiro, valor_total, status, codigo_tuss, nome, tb_parceiro_procedimento.id_parceiro',
