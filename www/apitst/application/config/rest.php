...
// $config['auth_override_class_method']['pessoafisica']['*'] = 'none';	
...
$config['auth_override_class_method_http']['usuario']['login']['post'] = 'none';
$config['auth_override_class_method_http']['usuario']['recupera_senha']['get'] = 'none';
$config['auth_override_class_method_http']['usuario']['recupera_senha']['post'] = 'none';
// $config['auth_override_class_method_http']['agendamento']['relatorio']['get'] = 'none';
...
|
*/
$config['rest_key_name'] = 'CF-API-KEY';
$config['user_key_name'] = 'CF-UID';
...
|
*/
$config['allowed_cors_origins'] = ['http://localhost:4500'];
