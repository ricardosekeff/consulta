...
class Financeiro extends REST_Controller {
	...
	function __construct()
	{
		...
		$this->methods['automatico_post']['limit'] = 10;
	}
	...
	public function automatico_post( $chave = null ) {
		if ($chave == 'FPHBDc9twBVFh58Us6AbcJrFLvF9zUS3Nt7bFHJEFxFeLZ2XbzddrFnywN35XwAv') {
			$this->response(array(
				'message' => 'chama'
			), REST_Controller::HTTP_OK);
			//fecha_ciclos_post();
